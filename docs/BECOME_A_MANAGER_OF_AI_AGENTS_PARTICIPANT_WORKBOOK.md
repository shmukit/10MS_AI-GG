<!--
PDF EXPORT (use this — plain Markdown-PDF often drops table borders)

  npm run export:workbook-pdf
  # or: python3 scripts/export_workbook_pdf.py

Needs: pip3 install markdown · Google Chrome
Output: docs/BECOME_A_MANAGER_OF_AI_AGENTS_PARTICIPANT_WORKBOOK.pdf
-->
<style>
...
**One-day instructor-led workshop · Participant Workbook**
...
> This is a **workshop companion**, not a textbook. Listen to the instructor. Use these pages to capture ideas, complete exercises, and take home a plan you can use on later. Write in the blanks. Leave pages messy. The value is in *your* notes, not the printed text.  
...
>
> **Finding a page:** Use the **page number at the bottom center** (same as the PDF viewer). Headers say **Sec XX** for the chapter — search **Task 1.5** if a section spans several sheets.
...
Use this map during the workshop. Instructors may say “open **Sec 12**” or “Task **1.1**.”

> **Page numbers:** The number at the **bottom center** of each PDF sheet is the real page (matches your PDF viewer). **Sec XX** in the header is the *section label* — one section can span more than one sheet.

**Task serial matches** the roadmap website and agenda slides: **0.0→0.4** · **1.1→1.6** (lock → tools → memory) · **2.0→2.6** · **3.0→3.6**.
...
| **04** | Session 0 · Opening | What is AI?                              | **0.0**     |
| **05** | Session 0 · Opening | What is Generative AI?                   |             |
| **06** | Session 0 · Opening | AI vs Traditional Software               |             |
| **07** | Session 0 · Opening | Chatbots vs Assistants vs Agents         |             |
| **08** | Session 0 · Opening | Teacher Agent & Labels (0.1–0.4)         | **0.1–0.4** |
| **09** | Session 0 · Opening | Prompt Engineering (CTAO)                |             |
| **10** | Section 1 · WITH    | Hallucination                            |             |
| **11** | Section 1 · WITH    | Human-in-the-loop                        |             |
| **12** | Section 1 · WITH    | Worksheet A — Work Assistant Brief              | **1.1–1.3** |
| **13** | Section 1 · WITH    | Worksheet B — Lock Process               | **1.4**     |
| **14** | Section 1 · WITH    | Choosing Tools & Tool Snapshots          | **1.5**     |
| **15** | Section 1 · WITH    | Context & Memory                         | **1.6**     |
| **16** | Section 2 · THROUGH | AI Workflows & Automation                |             |
| **17** | Section 2 · THROUGH | Knowledge, Projects & Pattern Ladder     | **2.0**     |
| **18** | Section 2 · THROUGH | Worksheet C — Workflow Canvas            | **2.1**     |
| **19** | Section 2 · THROUGH | ETCSLV Framework                         |             |
| **20** | Section 2 · THROUGH | Worksheet D — ETCSLV Draft               | **2.2–2.3** |
| **21** | Section 2 · THROUGH | Decision Tree & Type Cards               | **2.4–2.6** |
| **22** | Section 2 · THROUGH | Quick share & Reflection                   |             |
| **23** | Section 3 · BY      | From Helper to AI Workforce              | **3.0**     |
| **24** | Section 3 · BY      | Worksheet F — AI Workforce Canvas        | **3.1**     |
| **25** | Section 3 · BY      | Worksheet E — Harness Card               | **3.2**     |
| **26** | Section 3 · BY      | Failure Lab & Capstone                   | **3.3–3.5** |
| **27** | Section 3 · BY      | Delegation, Adoption Plan & Reflection   | **3.6**     |
| **28** | Reference           | R1 — Prompt Cheat Sheet                  |             |
| **29** | Reference           | R2–R3 — Tool Matrix & Workflow Checklist |             |
| **30** | Reference           | R4–R5 — ETCSLV Summary & Decision Tree   |             |
| **31** | Reference           | R6 — Ethics & Privacy Checklist          |             |
| **32** | Reference           | R7 — 30-Day Personal AI Adoption Plan    | **3.6**     |
| **33** | Reference           | R8 — Corporate Scenario Bank             |             |
| **34** | Reference           | R9 — Glossary                            |             |
| **35** | Big picture         | Day Roadmap — How every piece connects   | **0.0–3.6** |
| **36** | Notes               | Notes N1–N2                              |             |
| **37** | Notes               | Parking Lot, Wins & Closing              |             |
...
| Looking for…                         | Go to   |
| ------------------------------------ | ------- |
| Work Assistant Brief | Sec 12 |
| Lock today’s process                 | Sec 13 |
| Tool fit (1.5)                       | Sec 14 |
| Memory (1.6)                         | Sec 15 |
| Workflow Canvas                      | Sec 18 |
| ETCSLV Framework (teach)             | Sec 19 |
| ETCSLV draft                         | Sec 20 |
| Harness Card                         | Sec 25 |
| Capstone                             | Sec 26 |
| 30-day plan                          | Sec 32 |
| Scenario ideas                       | Sec 33 |
...
**Sec 04** · Session 0 · Opening · What is AI?
...
| -------------------------------------------------------------------------------- |
| **Do:** Follow the instructor. On this page (or a note), write one line you **expect** today and one you will **not** expect. |
| **Done when:** Both lines written. Mark roadmap **0.0** complete. |


**In plain words:**  
AI is software that can learn patterns from large amounts of data and then produce useful outputs — text, summaries, suggestions, classifications - without you writing every rule by hand.

**Analogy:**  
Think of a **very fast new junior** who has read a huge library of books, reports, and internet pages. They draft quickly and "**sound confident**". They still invent details when unsure. They need a manager who briefs them, checks the work, and decides what leaves the room.

**Corporate office examples:**  

- **HR:** Draft a first reply to a candidate asking about interview timing - you still confirm the real schedule.  
- **Operations:** Turn a messy WhatsApp thread into a clean action list - you still assign owners.  
- **Marketing:** Rewrite a product post in clearer Bangla - brand/compliance still approves before publish.  
- **Finance:** Draft a customer note about missing loan documents - checklist still get a human check.
...
1. Where in your week do you already act like a manager of juniors (brief → review → approve)?
  ---
2. What would you *never* let a junior send without your check?
  ---
...
**Sec 05** · Session 0 · Opening · What is Generative AI?

## 1.2 What is Generative AI?

**In plain words:**  
Generative AI creates *new* content from a prompt - emails, reports, Bangla/English rewrites, slide outlines, image ideas - instead of only retrieving a fixed answer from a database.

**Everyday analogy:**  
Traditional software is like a **fixed menu at a canteen**: press button → get the same dish.  
Generative AI is like a **skilled cook**: give ingredients and instructions → get a new plate each time. Taste before you serve.

**Office examples**


| Role                 | Generative AI can help with…                                             |
| -------------------- | ------------------------------------------------------------------------ |
| HR / Admin           | Offer letter, joining checklist, leave-policy FAQ from uploaded handbook |
| Operations           | Meeting notes → owners + deadlines; SOP Q&A for new joiners              |
| Marketing / Comms    | Three caption options; rewrite press note; slide outline from brief      |
| Sales / BD           | Visit notes → polite WhatsApp/email follow-up; proposal outline          |
| Analyst / Strategy   | Clean a messy Excel narrative; “what changed vs last month?” bullets     |
| Team lead / Manager  | Weekly update from scattered Slack/WhatsApp notes                        |
| Finance / Credit ops | Document investment memo draft; policy summary (you verify numbers)      |


**Hands-on box — Try once later today**


| Step | Do this                                                                 |
| ---- | ----------------------------------------------------------------------- |
| 1    | Paste 5 rough bullets about your week                                   |
| 2    | Ask AI: “Turn these into a 6-line manager update. No invented numbers.” |
| 3    | Cross out anything that feels wrong                                     |


**My sample output (paste or write key lines):**
...
**Sec 06** · Session 0 · Opening · AI vs Traditional Software

## 1.3 AI vs Traditional Software
...
- **HRIS / payroll / ERP / CRM** = traditional software (leave balances, invoice totals, order status).  
- **Drafting a weekly team update** from messy notes = generative AI.  
Do not mix them up: AI should not “invent” a leave balance or invoice total. The system of record should.

> **Callout**  
> Use traditional software for **truth that must not drift**. Use generative AI for **language, structure, and first drafts**.
...
**Sec 07** · Session 0 · Opening · Chatbots vs Assistants vs Agents

## 1.4 Chatbots vs AI Assistants vs AI Agents


**Workplace analogy (remember this):**
...
| Situation                                                        | Best fit            |
| ---------------------------------------------------------------- | ------------------- |
| Quick rephrase of a Slack message to your boss                   | Chat                |
| Standing helper for your weekly team / client update             | Assistant (Project) |
| New Google Form → draft onboarding pack → queue for HR review    | Agent / workflow    |
| Ticket / email → SOP-based draft reply → agent sends after check | Agent / workflow    |
...
**Sec 08** · Session 0 · Opening · Teacher Agent & Labels (0.1–0.4)
...
**Sec 09** · Session 0 · Opening · Prompt Engineering (CTAO)

## 1.5 Prompt Engineering (clear instructions)

**In plain words:**  
A prompt is a work brief. Better briefs → better first drafts. You still review.
...
| Weak                           | Stronger                                                                                                                                                                                                         |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| “Write email about documents.” | “Role: HR BP. Task: soft reminder that NID copy and signed offer letter are still pending. Tone: respectful. Language: Bangla or English. Max 120 words. Do not invent a deadline. Output: one email body only.” |


**Exercise — Rewrite your weak prompt**

*Starter if stuck — then write your own:*
...
**Sec 10** · Section 1 · WITH · Hallucination

## 1.8 Hallucination

**In plain words:**  
Hallucination is when AI invents details that sound right but are not true — fake citations, wrong numbers, made-up clause numbers, imaginary employee or customer facts.

**Analogy:**  
A confident junior filling gaps in a board pack so it “looks complete.” Dangerous in any office where numbers and promises matter.

**High-risk zones in corporate offices**

- Headcount, salary, bonus, or budget figures  
- Legal, HR, or compliance wording (“policy says…”) without a source  
- Customer or employee PII (NID, phone, salary, medical)  
- Marketing claims and competitor comparisons  
- Promises to clients, vendors, or candidates (“we will confirm by Friday”)  
- Finance-specific: rates, fees, EMI, regulatory language

**Detection habits**

1. Ask: “Cite the source or say unknown.”
2. Spot-check numbers against the system of record.
3. Never paste secrets you should not share with a vendor tool.
4. Prefer “draft + checklist” over “final answer.”

**Trap exercise (instructor may demo)**  
Ask AI a question about a policy you *did not* upload. Note whether it invents.
...
**Sec 11** · Section 1 · WITH · Human-in-the-loop

## 1.9 Human-in-the-loop

**In plain words:**  
A human must approve steps that affect customers, money, legal/compliance, people decisions, or public reputation.

**Red / Blue / Green (kitchen tags)**
...
*You will reuse these tags when you map your process (Worksheet B sketch · Workflow Canvas). Same meanings every time.*

**Always human before…**

- [ ] External email / SMS / WhatsApp to customer, vendor, or candidate  
- [ ] Changing official records (HRIS, ERP, CRM)  
- [ ] Publishing marketing / social posts  
- [ ] HR letters with compensation or termination language  
- [ ] Hiring, budget, legal, credit, or compliance decisions  

**My personal red lines**

*e.g. (1) Any email leaving the company (2) Numbers in a board/manager pack (3) HR letters with pay or exit language*
...
**Sec 12** · Section 1 · WITH · Worksheet A — Work Assistant Brief

# SECTION 1 — Work WITH AI

*Goal: Use AI as a daily helper — clear instructions, the right tool, and human judgment.*

**Session 1 task order:** **1.1 → 1.2 → 1.3 → 1.4 → 1.5 → 1.6** (lock the job before tools).
...
| -------------------------------------------------------------------------------- |
| **Do:** Complete the brief below first (paper/this page — **no AI yet**). Keep it short enough that a stranger could follow it. |
...
*Think first. Fill this before you “hire” your assistant in the AI tool.*  
...
**Three real tasks I will run today with this Work Assistant**

*Ideas:* rewrite one real email · clean one meeting note into actions · draft one weekly update from bullets
...
**Feedback notes (after Teacher critiques once)**  
What I changed in Settings:  
*e.g. Added “never invent numbers” + “ask if bullets missing”*
...
**Sec 13** · Section 1 · WITH · Worksheet B — Lock Process
...
**Green / Blue / Red first sketch** (optional — refine in Session 2)
...
*Key: 🟢 **Green** = AI thinking (draft, summarize, rewrite) · 🔵 **Blue** = rules / automation (forms, reminders, moving data) · 🔴 **Red** = human only (send externally, money, hiring, legal)*
...
**Sec 14** · Section 1 · WITH · Choosing Tools & Tool Snapshots

## 1.10 Choosing the right AI tool
...
| Lane | Need | Example tools (illustrative) |
| ---- | ---- | ---------------------------- |
| **A** Think & draft | Daily writing / Work Assistant | ChatGPT, Claude |
| **B** Research web | Public news + citations | Perplexity, Gemini |
| **C** Your files | Policy / SOP Q&A from *your* docs | NotebookLM, Projects with uploads |
| **D** See / hear / show | Decks, images, voice, screenshots | Gemini, Gamma, ChatGPT images, etc. |
| **E** Connect & run | Trigger → AI → Doc/Sheet | Zapier / Make / n8n (+ Forms/Sheets) |


*Same A–E letters appear in the tool snapshots below. Use them in the matching exercise.*


**Fit questions**

1. Do I need one finished draft — or many steps?
2. Must the answer come from **company files**?
3. Will a human approve each sensitive step?

**My stack for today’s locked process (max 3)**

*Starter stack many people use today:* ChatGPT or Claude (Work Assistant) · NotebookLM or Project files (SOPs) · Google Form/Sheet (trigger). Keep only what *your* job needs.
...
## 1.11 Tool snapshots — learn the *job*, not the brand

> **Disclaimer — tools change fast**  
> Names on this page are **examples for today**. In **6–12 months**, a different product may be more popular or better. Do **not** cling to brands. Learn the **core job** each type of tool does, then pick whatever your company allows that fits *this* process.

**How to read any AI tool (the durable part)**


| Core job                           | What it does for you                          | Ask before you buy in                  |
| ---------------------------------- | --------------------------------------------- | -------------------------------------- |
| **Think & draft**                  | Writes, rewrites, critiques, plans            | Standing brief / Projects? Privacy OK? |
| **Research the open web**          | Finds current public info + links             | Can I open and verify citations?       |
| **Answer from *my* files**         | Uses your PDFs/SOPs, not only internet memory | Are my files allowed in this tool?     |
| **See / hear / show** (multimodal) | Images, voice, slides, screenshots            | Is the output good enough to review?   |
| **Connect & run**                  | Trigger → AI → Doc/Sheet/email draft          | Human approval before send?            |
...
### A. Text & reasoning (daily desk)


| Example (today) | Core strength                                                          | Good for…                            | Watch-outs                        |
| --------------- | ---------------------------------------------------------------------- | ------------------------------------ | --------------------------------- |
| **ChatGPT**     | Flexible all-rounder; Projects; can also do images/voice on many plans | Work Assistant, drafts, light analysis      | Plan limits; check facts; privacy |
| **Claude**      | Careful writing; strong with long documents                            | Policies, reports, coaching critique | Verify numbers; privacy           |
| **Gemini**      | Strong if you live in Google Docs/Drive                                | Docs-linked work, multimodal assist  | Confirm where data is stored      |


*Way of work:* One standing Project/instructions = your Work Assistant. Chat without a brief = hallway question only.

### B. Research with sources


| Example (today)       | Core strength               | Good for…                             | Watch-outs                           |
| --------------------- | --------------------------- | ------------------------------------- | ------------------------------------ |
| **Perplexity**        | Answers with web citations  | “What’s current?” market / news scans | Links can still be wrong — open them |
| **Gemini** (web mode) | Research + Google ecosystem | Quick public lookup beside Docs       | Same: verify before you trust        |


*Way of work:* Use for **public** questions. Not a substitute for your internal policy binder.

### C. Knowledge from *your* documents


| Example (today)                              | Core strength                             | Good for…                                | Watch-outs                            |
| -------------------------------------------- | ----------------------------------------- | ---------------------------------------- | ------------------------------------- |
| **NotebookLM**                               | Grounded in files *you* upload; citations | SOP / handbook / policy Q&A              | Only as good as the files you give it |
| **ChatGPT / Claude Projects** (with uploads) | Brief + files in one place                | Recurring job that needs company context | Don’t upload secrets your IT forbids  |


*Way of work:* Upload → ask → **click the citation** → verify. If the file is missing, “I don’t know” is success.

### D. Multimodal (top types — not a catalog)


| Type                             | Core job                                 | Example (today)                                                      | Good for…                                    | Watch-outs                                                 |
| -------------------------------- | ---------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------- | ---------------------------------------------------------- |
| **Image**                        | Create or edit visuals                   | ChatGPT / Gemini image features                                      | Rough creatives, diagrams, mockups           | Brand/legal review before publish                          |
| **Voice / meeting**              | Speech → notes or talk-to-AI             | Built-in voice in ChatGPT/Gemini; meeting notetakers your org allows | Visit notes, action lists                    | Confirm speakers/facts; privacy on recordings              |
| **Slides / docs layout**         | Turn bullets into a deck or polished doc | Gemini + Google Slides; Gamma (or similar)                           | First-pass presentation structure            | You still own the story and numbers                        |
| **Screenshot / file “see this”** | Read what’s on screen or in a photo      | Multimodal chat (ChatGPT, Claude, Gemini)                            | Extract text from a form photo; explain a UI | Blur PII; don’t photograph confidential screens carelessly |


*Way of work:* Multimodal speeds a **first draft**. Human still tastes before it leaves the kitchen.

### E. Connect & run (light automation)


| Example (today)                        | Core strength                                   | Good for…                   | Watch-outs                                        |
| -------------------------------------- | ----------------------------------------------- | --------------------------- | ------------------------------------------------- |
| **Zapier / Make / n8n** + Forms/Sheets | Trigger starts the path without you remembering | Form → AI draft → Doc/Sheet | Keep day-one automation humble; human before send |


*Way of work:* Trigger → AI → output location → **approval**. Fancy multi-agent setups wait until one path already runs.

---

<div class="page-break" style="page-break-before: always; break-before: page;"></div>

**Manager rule:** Lock the **job** → name the **core jobs** you need (**A–E**) → pick **≤3** tools that do those jobs → ignore the hype list.
...
**Exercise — Match the *job type* (then name a tool)**

**A–E key (use these letters):**  
**A** Think & draft · **B** Research web · **C** Your files · **D** See / hear / show · **E** Connect & run

*Think lane first (write A, B, C, D, or E), then write any tool that fits today.*
...
**Sec 15** · Section 1 · WITH · Context & Memory

## 1.6 Context

**In plain words:**  
Context is everything AI needs *in this conversation* to do the job — role, product, audience, constraints, and the actual content (notes, policy excerpt, table).

**Analogy:**  
Briefing a new hire *before* they write a customer letter: who the customer is, what product, what you may / may not promise.

**Without context:** AI guesses from the public internet.  
**With context:** AI works from *your* brief.

**Mini checklist — Did I give enough context?**

- [ ] Who I am / my role  
- [ ] Who the audience is  
- [ ] The raw material (paste notes / excerpt)  
...
| **Order:** Do this **after** Task **1.4** (lock) and **1.5** (tools). |


**In plain words:**  
Memory is what sticks beyond one message — Project instructions, uploaded files, past chat in the same thread, or saved preferences.
...
**Sec 16** · Section 2 · THROUGH · AI Workflows & Automation
...
③ What happens on the floor?  Map steps + 🟢 Blue thinking / 🔵 rules / 🔴 human (Task 2.1)
...
| Step | You learn | You leave with |
| ---- | --------- | -------------- |
| ① Destination | What “workflow” means | Same picture all afternoon |
| ② Ladder | Don’t overbuild | A height for *this* job |
| ③ Map + tags | Where AI vs rules vs you | Floor plan of the locked process |
| ④ ETCSLV | Learn framework, then draft (esp. L & V) | Limits + validation you can test |
| ⑤ Lock pattern | Simplest type that fits | One pattern name (not a menu of options) |
...
**In plain words:**  
An AI workflow is a **repeatable path**: something starts the work → AI (and maybe other systems) do clear steps → a result appears where your team already works → a human still owns risk.

**Analogy:**  
Reception → desk → manager approval. AI can sit at some desks; it should not steal the manager’s approval.
...
| Trigger                       | AI step                               | Output                    | Human                    |
| ----------------------------- | ------------------------------------- | ------------------------- | ------------------------ |
| New joiner Google Form        | Draft day-1 checklist + welcome email | Doc + Gmail draft         | HR reviews before send   |
| Weekly bullets in Sheet       | Turn into manager / client update     | Google Doc draft          | Manager signs off        |
| Support ticket / shared inbox | Tag issue + draft SOP-based reply     | Sheet column + draft mail | Agent / owner sends      |
| Campaign brief in Drive       | 3 caption options + slide outline     | Doc / Slides draft        | Brand lead approves      |
| Policy / handbook PDF         | Answer staff FAQ with citations       | Chat answer               | Policy owner spot-checks |


> You will **not** automate yet. First you choose height (ladder), map steps, write rules, lock a pattern, and write the brain. Automation comes at **Task 2.6**.
...
**Sec 17** · Section 2 · THROUGH · Knowledge, Projects & Pattern Ladder

## 2.3 Knowledge assistants & RAG (plain language)

**Knowledge assistant:** AI that answers using **your** documents (SOPs, product sheets, HR policy), not only public internet memory.

**RAG (Retrieval-Augmented Generation) — one sentence:**  
Before answering, the system **finds relevant passages from your files**, then writes an answer grounded in those passages (ideally with citations).

**Analogy:**  
Instead of guessing leave rules or expense policy from memory, the junior **opens the HR binder on the desk**, then drafts.

**Good uses:** leave/expense policy Q&A, onboarding FAQs, brand guidelines, product sheets your company uploaded.  
**Still your job:** verify citations; update files when policy changes.

---



## 2.4 Reusable AI assistants & AI Projects
...
**Identity rule for today:**  
Extend your Work Assistant **or** create **one** worker Project for the locked job — not five mystery bots.
...
**Sec 18** · Section 2 · THROUGH · Worksheet C — Workflow Canvas

## Worksheet C — Map your process — Step ③

*Tag each step: 🟢 AI thinking · 🔵 rules / automation · 🔴 human only.*
...
*Map the process. Leave space. Messy is fine.*  
*Row 1–4 show a starter path — replace with yours.*
...
(Use this space to redraw freely)
...
**Still requires a human:** *e.g. Final send + any number that affects decisions* _________________________________________________
...
**Sec 19** · Section 2 · THROUGH · ETCSLV Framework
...
**Say the picture first:**  
Before you open a new role (or onboard a new hire), you decide: how hard is the work, which systems they touch, what they must always know, what files stay, what they may never do alone, and how you check quality.
...
> **Callout**  
> **Harness = the same ETCSLV checklist**, named for shipping. You will reuse it in Session 3.
...
**Sec 20** · Section 2 · THROUGH · Worksheet D — ETCSLV Draft

## Worksheet D — ETCSLV draft — Step ④

> Fill this **after** the ETCSLV Framework page (Sec 19) and Tasks **2.2–2.3**.
...
Hardest letter for me: *often S, L, or V* ______ because _________________________________________
...
**Sec 21** · Section 2 · THROUGH · Decision Tree & Type Cards

## 2.7 Decision Tree — Find the simplest help — Step ⑤
...
*(Types 4 and 7 appear for coding / quality-check jobs — see Reference section.)*
...
## 2.8 Make it run — Track A or Track B — Step ⑦

**In plain words:**  
Automation means the path can **start without you remembering** (“when the form hits reception, the file opens”). Day one stays humble: one trigger, one AI step, one output, one approval.


| Manual WITH AI (Session 1) | THROUGH AI running path (now) |
| -------------------------- | ----------------------------- |
| You open chat and paste    | Something starts the path     |
| You copy the result        | Result lands where work lives |
| Easy to forget             | You can re-trigger without the instructor |


### Track A vs Track B (pick one — both count)
...
| **When** | Wi‑Fi + tool access OK | Corporate laptop blocks automation, no time to wire tools, or IT forbids |
...
**Sec 22** · Section 2 · THROUGH · Quick share & Reflection

## Quick share — Workflow spotlight (5–10 min)

Everyone works **on their own**. No pair work.

When the instructor asks, a **volunteer** — or someone **picked at random** — explains their workflow to the room in about **60 seconds**:

1. What is the locked process?
2. Where is the **human approval** (🔴)?
3. What must AI **never invent**?

Listeners: note one idea you might steal for your own L or V.

**Idea I heard that I might use:**  

---

**I will change in my L or V:**  
...
**Sec 23** · Section 3 · BY · From Helper to AI Workforce
...
## 3.1 From helper to workforce

**Manager truth:**  
You do not personally write every email, check every cell, and design every slide. You **coordinate specialists**, set standards, and own exceptions.

Managing AI is the same:
...
| Piece          | Manager question                               |
| -------------- | ---------------------------------------------- |
| **Model**      | Which AI for draft vs judgment-heavy critique? |
| **Memory**     | What files and standing rules?                 |
| **Tools**      | Sheet, Doc, Form, email draft — which ones?    |
| **Workflow**   | Trigger → steps → output                       |
| **Evaluation** | Checklist, sample audit, Demo Day criteria     |
...
**Corporate sketch A — New joiner onboarding pack**


| Role               | Does                                                     |
| ------------------ | -------------------------------------------------------- |
| Researcher         | Pull day-1 checklist from approved HR handbook           |
| Writer             | Draft welcome email + checklist                          |
| Reviewer           | Flag any salary / benefit language that was not provided |
| Human manager (HR) | Sends or edits                                           |


**Corporate sketch B — Weekly management update**


| Role          | Does                                          |
| ------------- | --------------------------------------------- |
| Planner       | Outline sections: wins, risks, asks           |
| Writer        | Draft narrative from team bullets             |
| Evaluator     | Check “no invented numbers” against the Sheet |
| Human manager | Approves before email / Slack post            |
...
**Sec 24** · Section 3 · BY · Worksheet F — AI Workforce Canvas
...
**Sec 25** · Section 3 · BY · Worksheet E — Harness Card
...
| --- | --- | --- |
| Workflow name | *Friday Team Update Draft* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| Owner (human manager) | *Me (Ops Lead)* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **E** How hard / multi-step? | *Multi-step: collect → draft → tone pass* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **T** Tools (+ cheap vs expensive) | *$ Sheet+Doc draft · $$$ only if legal review* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **C** Always-on context | *Audience, forbidden claims, section template* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **S** What must persist | *Last update file + standing Settings* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **L** Hard limits / approvals | *No send; no invented metrics; escalate missing bullets* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| **V** How we validate | *Number-source checklist + human sign-off* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| Failure test I will try | *Submit empty bullets / ask it to invent a %* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
| Pass / fail rule | *Pass only if it asks for missing input and refuses invented %* | <div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div><div style="border-bottom:1px solid #666;height:1.4em;margin:0.25em 0"></div> |
...
**Sec 26** · Section 3 · BY · Failure Lab & Capstone
...
| Attack                     | Example                                         | What I observed | Fix |
| -------------------------- | ----------------------------------------------- | --------------- | --- |
| Missing input              | Empty bullets                                   |                 |     |
| Messy / Bangla-English mix | *e.g. Half Bangla WhatsApp paste*               |                 |     |
| Forbidden ask              | “Promise a salary / discount we never approved” |                 |     |
| Overconfident draft        | Invented metric                                 |                 |     |


**One fix I shipped after Failure Lab:**  
...
| -------------------------------------------------------------------------------- |
| **Do:** Live-demo trigger → AI → output → human approval (or recording from last 10 min). Say: pain → run → who approves → one risk you fixed. Peer notes one strength + one improvement. |
| **Done when:** Demo shown + peer row filled. Mark roadmap **3.5** complete. |


**Definition of done**

- [ ] Trigger is real (form / sheet / paste / email label — as designed)  
- [ ] AI step uses standing instructions (workflow brain)  
- [ ] Output lands where work lives  
- [ ] Human approval step is visible  
- [ ] I can re-run without the instructor  
- [ ] L and V match what I built  
...
**Sec 27** · Section 3 · BY · Delegation, Adoption Plan & Reflection
...
- [ ] Role and outcome are clear  
- [ ] Audience and tone set  
- [ ] Forbidden content listed  
- [ ] Output format specified  

**Safety**

- [ ] No unnecessary PII in the prompt  
- [ ] Red steps marked human-only  
- [ ] Hallucination checks for numbers / policy  

**Operate**

- [ ] Right tool for this job (≤3)  
- [ ] Memory / files attached if required  
- [ ] Validation method named (V)  
- [ ] Someone owns exceptions (you)

**Ship**

- [ ] Ran once successfully  
- [ ] Failure case tested once  
- [ ] Documented in one paragraph for your future self  
...
| **Accountability buddy**       | *e.g. Desk neighbor / team lead*                      |


*(Full calendar is in the Reference section — complete it before you leave.)*
...
**Sec 28** · Reference · R1 — Prompt Cheat Sheet
...
**Sec 29** · Reference · R2–R3 — Tool Matrix & Workflow Checklist
...
| Slides / visuals             | Gemini / Gamma / ChatGPT images | —                       | Perfect brand compliance without review |
...
**Sec 30** · Reference · R4–R5 — ETCSLV Summary & Decision Tree
...
**Sec 31** · Reference · R6 — Ethics & Privacy Checklist
...
**Sec 32** · Reference · R7 — 30-Day Personal AI Adoption Plan

## R7 — 30-Day Personal AI Adoption Plan

**Theme for 30 days:** *e.g. “One Friday workflow I can re-run without thinking”* _______________________________________
...
**Sec 33** · Reference · R8 — Corporate Scenario Bank
...
| **Internal reporting**              | Bullets → management narrative                   | Monthly pack sections auto-drafted               | Manager validates figures             |
| **Learning / L&D**                  | Lesson plan from syllabus PDF                    | Feedback drafts scored to rubric                 | Facilitator overrides edge cases      |
| **IT / Admin support**              | Soft reboot / access FAQ from SOP                | Ticket form → category + first reply draft       | IT agent closes or escalates          |
| **Finance institutions (optional)** | Document chase; product FAQ draft                | Inquiry Form → checklist Doc → RM queue          | RM sends; credit decision stays human |
...
*Become a Manager of AI Agents · Participant Workbook · Sec 33*


<div class="page-break" style="page-break-before: always; break-before: page;"></div>

**Sec 34** · Reference · R9 — Glossary
...
*Become a Manager of AI Agents · Participant Workbook · Sec 34*


<div class="page-break" style="page-break-before: always; break-before: page;"></div>

**Sec 35** · Big picture · Day Roadmap — How every piece connects
...
### The spine (read left → right)

| ① | ② | ③ | ④ | ⑤ | ⑥ |
|---|---|---|---|---|---|
| **Teacher** coaches you | **Work Assistant** does daily drafts | **Lock one process** | **Map + ETCSLV** = process map + rules | **Brain + automation** = standing brief + trigger | **Workforce + harness** = manage & ship |
...
*Become a Manager of AI Agents · Participant Workbook · Sec 35*


<div class="page-break" style="page-break-before: always; break-before: page;"></div>

**Sec 36** · Notes · Notes N1–N2
...
*Become a Manager of AI Agents · Participant Workbook · Sec 36*


<div class="page-break" style="page-break-before: always; break-before: page;"></div>

**Sec 37** · Notes · Parking Lot, Wins & Closing
...
*Aligned with workshop arc: Sessions 0–3 · Practical Agentic AI curriculum*  
*For instructor-led use; complements live demos and roadmap tasks — does not replace them.*

*Become a Manager of AI Agents · Participant Workbook · Sec 37*
