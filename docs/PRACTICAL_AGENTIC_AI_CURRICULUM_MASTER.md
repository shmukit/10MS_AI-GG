...
3. **Teacher ↔ Work Assistant switch once** (Session 1 feedback round). Not every task.
4. **Copy-paste less; think and review more.** After each AI reply: stop, read, decide what is wrong, then act.
5. **At most one “paste into Settings”** per Project (Teacher at 0.2, Work Assistant at 1.2, workflow brain once at 2.5).
...
| **Staff the process** | Workflow brain (Settings for this job) | **2.5** | Pattern locked |
...
| Work **THROUGH** AI | AI helps run *the job* on a path | A reception → desk → approval process |
...
| Teacher vs Work Assistant | External trainer who coaches you all day vs your own secretary who does the daily work |
| Chat / assistant / agent | Hallway question to whoever’s free vs hired desk assistant with a standing brief vs routed office process (intake → desk → approval) |
...
| ETCSLV / Harness | Checklist before starting a new desk process: how hard (E), which systems (T), what they must always know (C), what files stay (S), what they may never do alone (L), how you check quality (V). **Harness = the same checklist**, named for shipping |
...
| Failure lab | Mystery-shopper / fire drill on your own process |
...
| -- | ---- | --- | ---- | ----------------- |
| 0.0 | What is AI? What to expect / not expect | 5 | attend | — (day starts here) |
...
| 0.3 | Kickoff chat with Teacher (same chat all day from here) | 10 | project | …hired the coach — start the all-day conversation |
...
| AI tools | Teacher Project, Work Assistant Project, NotebookLM, automation, etc. |
