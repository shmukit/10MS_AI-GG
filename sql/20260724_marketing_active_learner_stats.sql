-- Forward-fixes: marketing "Avg program completion" and "Active Learners" stats.
-- Active learner = non-admin student who finished at least week 1 of any batch
-- (completed_weeks >= 1 on student_batch_assignments).
-- Completion rate = average progress_percentage among those active learners only.
-- Run in Supabase SQL Editor after 20260723_public_marketing_page_rpc.sql.
